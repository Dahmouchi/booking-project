                  ...
                  <Link href={item.url}>
                    <SidebarMenuButton
                      ...
                      className={clsx(
                        ...
                        isActive
                          ? "bg-[#b91d00] shadow-[4px_6px_7px_0px_rgba(0,_0,_0,_0.1)]  text-white hover:bg-orange-700 hover:text-white  font-semibold"
                      ...
                      <div
                        className={`${
                          isActive && state === "expanded"
                            ? "bg-white rounded-full p-1.5 text-[#b91d00]"
                            : ""
                        }`}
                      >
                        {" "}
